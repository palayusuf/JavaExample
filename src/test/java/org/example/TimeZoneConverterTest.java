...
public class TimeZoneConverterTest {
    ...
    public void testConvertInstantToNewYork() {
        Instant fixedInstant = Instant.parse("2024-08-08T01:15:00Z");
    ...
    public void testConvertInstantToLosAngeles() {
        Instant fixedInstant = Instant.parse("2024-08-08T21:15:00Z");
    ...
    public void testConvertInstantToBrussels() {
        Instant fixedInstant = Instant.parse("2024-08-08T12:15:00Z");
    ...
    public void testConvertInstantToBangkok() {
        Instant fixedInstant = Instant.parse("2024-08-08T20:15:00Z");
